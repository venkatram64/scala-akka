package com.venkat.scala.section1.counter

import akka.actor.{ActorSystem, Props}
import akka.testkit.{ImplicitSender, TestKit, TestProbe}
import com.venkat.section1.counter.Counter
...
class CounterSpec extends TestKit(ActorSystem("test-system"))
                      with FlatSpecLike
                      with ImplicitSender // for TestProbe()
  ...
  "Couner Actor" should "handle GetCount message with using TestProbe" in {
